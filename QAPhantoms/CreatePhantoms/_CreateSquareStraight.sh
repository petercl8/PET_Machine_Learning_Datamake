...
PhantomName=PhantomSquareStraight
PhantomHeight=200 # in mm. Height of the phantom that is in the FOV of the scanner. Used to set the correct activity level.
...
generate_image ${Path}ParFiles/square_basicShape-straight.par
