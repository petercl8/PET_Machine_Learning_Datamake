...
#P i\ = sed command to insert text before the given line number (before end of interfile)
#P input file = $STIRFilename, output = $GATEFilename --> Only $GATEFilename is changed.
sed $LineNum'i\
