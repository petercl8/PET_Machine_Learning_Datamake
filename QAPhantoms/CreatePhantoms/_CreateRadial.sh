...
####
# Script for producing a radial phantom. Activity is scaled so that the activity/cm (axial direction) for this phantom equals the activity/cm for a XCAT phantom.
####
...
## XCAT Parameters
## ---------------
XCAT_phantomPath=${Path}XCAT_phantom/male_pt141_torso_D690.hv # Path to a full-size XCAT phantom (will be used to set the activity of the NEMA phantom so that the activity/slice is the same as the XCAT phantom)
...
generate_image ${Path}ParFiles/radial_basicShape_20mm.par
